...
public class AfricaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScrollView scrollView = findViewById(R.id.africa_layout);
        scrollView.setBackgroundResource(R.drawable.african_landscape);
        scrollView.getBackground().setAlpha(125);
        ...
        Button submitScore = findViewById(R.id.afro_submit_answers);
        submitScore.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                switch (radioGroupOne.getCheckedRadioButtonId()) {
                    case R.id.radio_1_2:
                        userAns1 = getString(R.string.afro_user_ans_12);
                        break;
                    case R.id.radio_1_1:
                        score += 1;
                        userAns1 = getString(R.string.afro_user_ans_11);
                        break;
                    case R.id.radio_1_3:
                        userAns1 = getString(R.string.afro_user_ans_13);
                        break;
                }
                if (!radioOneAns1.isChecked() && !radioOneAns2.isChecked() && !radioOneAns3.isChecked()) {
                    userAns1 = getString(R.string.afro_user_ans_14);
                }
                ...
                switch (radioGroupTwo.getCheckedRadioButtonId()) {
                    case R.id.radio_2_3:
                        score += 1;
                        userAns2 = getString(R.string.afro_user_ans_21);
                        break;
                    case R.id.radio_2_1:
                        userAns2 = getString(R.string.afro_user_ans_23);
                        break;
                    case R.id.radio_2_2:
                        userAns2 = getString(R.string.afro_user_ans_22);
                        break;
                }
                if (!radioTwoAns1.isChecked() && !radioTwoAns2.isChecked() && !radioTwoAns3.isChecked()) {
                    userAns2 = getString(R.string.afro_user_ans_24);
                }
                ...
                if (answer3EditBox.getText().toString().equalsIgnoreCase("Victoria")) {
                    ...
                    userAns3 = getString(R.string.afro_user_ans_32);
                } else {
                    userAns3 = getString(R.string.afro_user_ans_33);
                }
                ...
                if (answer4EditBox.getText().toString().equalsIgnoreCase("Abuja")) {
                    ...
                    userAns4 = getString(R.string.afro_user_ans_42);
                } else {
                    userAns4 = getString(R.string.afro_user_ans_43);
                }
                ...
                strMaster2 = getString(R.string.afro_answers);
                strMaster3 = getString(R.string.afro_stringAns1);
                strMaster4 = getString(R.string.afro_stringAns2);
                strMaster5 = getString(R.string.afro_stringAns3);
                strMaster6 = getString(R.string.afro_stringAns4);
                strMaster7 = getString(R.string.afro_stringAns5);
